...
class Employee(models.Model):
    ...
    # region = models.CharField(('Region'),help_text='what region of the country(India) are you from ?',max_length=20,default=GREATER,choices=GHANA_REGIONS,blank=False,null=True)
